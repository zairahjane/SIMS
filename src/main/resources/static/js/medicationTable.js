...
document.addEventListener("DOMContentLoaded",function(){
	...
	let itemPage = new PageSearch(`/api/swine/${swineID}/medicationList`);
	...
	//sorter
	let itemSorter = new Sorter(itemPage,0,4,itemTableControls);
