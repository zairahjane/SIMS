...
document.addEventListener("DOMContentLoaded",function(){
	...
	let itemPage = new PageSearch(`/api/swine/${swineID}/pregnancyList`);
	...
	//sorter
	let itemSorter = new Sorter(itemPage,0,2,itemTableControls);
	...
	th[0].addEventListener("click",function(){
		itemSorter.sortTable("pregnancyID");
		itemSorter.setSortedColumn(0);
	});
	
	th[1].addEventListener("click",function(){
		itemSorter.sortTable("pregnancyDate");
