...
document.addEventListener("DOMContentLoaded",function(){
	...
	let itemPage = new PageSearch(`/api/swine/${swineID}/feedingList`);
	...
	//sorter
	let itemSorter = new Sorter(itemPage,0,5,itemTableControls);
